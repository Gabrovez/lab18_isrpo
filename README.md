...
**ФИО:** Катаржин Григорий МИхайлович
...
- Базовые концепции JavaScript и их сравнение с C#
...
* index.html -  файл для работы с main.js  в браузере
* main.js - файл с кодом javascript
* img/ - скриншоты по лабе
